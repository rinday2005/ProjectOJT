  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      try {
        ...
        // Refresh adminProfile queries in React Query to update the topbar/sidebar in real-time
  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-12 animate-pulse">
        <div className="h-40 bg-stone-200 rounded-[2rem] mb-8"></div>
  ...
  if (isError) {
    return (
      <div className="max-w-md mx-auto py-16 px-4 text-center">
        ...
        <h2 className="text-xl font-bold text-stone-800">Unable to load profile info</h2>
    ...
    <div className="max-w-4xl mx-auto px-6 py-12 font-manrope">
      ...
      <div className="relative bg-gradient-to-r from-[#0d8ca5] to-[#5fa5ba] rounded-[2rem] overflow-hidden p-8 text-white shadow-xl shadow-teal-100/10 mb-8">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
          ...
          <div>
            <h1 className="text-2xl font-black">{profile?.fullName || 'Admin User'}</h1>
            <p className="text-white/80 text-xs tracking-wider uppercase mt-1.5 font-bold">{profile?.role || 'Admin'} Profile</p>
      ...
      {/* Main Profile Form */}
      <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] border border-stone-100 shadow-xl shadow-teal-100/5">
        <div className="flex items-center gap-2.5 mb-8 pb-4 border-b border-stone-100">
          ...
          <h2 className="font-extrabold text-stone-900 text-lg">Account Details</h2>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-stone-450">
                  <User size={16} />
                </div>
                <input
                  type="text"
                  {...register('fullName', { required: 'Full Name cannot be empty' })}
                  className={`w-full pl-11 pr-4 py-3 bg-stone-50 border ${
                    errors.fullName ? 'border-red-500 animate-shake' : 'border-stone-150'
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 bg-stone-50 border ${
                    errors.phone ? 'border-red-500 animate-shake' : 'border-stone-150'
                  } rounded-2xl text-sm focus:outline-none focus:ring-1 focus:ring-[#0d8ca5]`}
                />
              </div>
              {errors.phone && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={profile?.email || ''}
                  disabled
                  className="w-full pl-11 pr-4 py-3 bg-stone-100/50 border border-stone-150 text-stone-400 rounded-2xl text-sm cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-stone-50 border border-stone-150 rounded-2xl text-sm focus:outline-none focus:ring-1 focus:ring-[#0d8ca5]"
                />
              </div>
            </div>
          </div>
